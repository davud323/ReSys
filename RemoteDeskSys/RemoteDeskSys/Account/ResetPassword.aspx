<%@ Page Title="重設密碼" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="RemoteDeskSys.Account.ResetPassword" Async="true" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="Reset_Click" Text="重設" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
